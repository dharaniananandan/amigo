...
function initSdk(name) {
    ...
    setTimeout(function() {
        ...
        var chatWidgetSettings = {
			...
			initUserHiddenMessage: 'Hi Amigo',
			botIcon: 'images/botButtonIcon.gif',
			botButtonIcon: 'images/botButtonIcon.gif',
			personIcon: 'images/user-icon.png',
			logoIcon: 'images/botButtonIcon.gif',
			font: '12px "Helvetica Neue", Helvetica, Arial, sans-serif',
			messagePadding: '6px',
            URI: 'gc3odaejas01-gc35001.botmxp.ocp.oraclecloud.com', // ODA URI, only the hostname part should be passed, without the https://
            clientAuthEnabled: isClientAuthEnabled,     // Enables client auth enabled mode of connection if set true
            channelId: '37ab345b-2a37-4cf1-a909-0da81ec6b627',                   // Channel ID, available in channel settings in ODA UI
            ...
            i18n: {                                     // Provide translations for the strings used in the widget
                en: {                                   // en locale, can be configured for any locale
                    chatTitle: 'Amigo',    				// Set title at chat header
					chatSubtitle: 'Helping your need in OCSC'        // Replaces Connected
                }
            },
